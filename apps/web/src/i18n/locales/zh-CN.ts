export default {
  ...
  hoverAccept: {
    ...
    work: "工作区",
    compare: "对照",
    /** Work has no text here — will insert from compare */
    workEmptyInsert: "（工作区此处目前没有文字）",
    workEmpty: "（工作区无对应文字）",
    /** Compare has no text — will delete from work */
    compareEmptyDelete: "（对照侧没有这段文字）",
    compareEmpty: "（对照侧无对应文字）",
    insertLead: "将把下面这段对照文字插入到工作区对应位置：",
    deleteLead: "将从工作区删除下面这段文字（对照侧已无此内容）：",
    apply: "采纳替换",
    applyInsert: "插入到工作区",
    applyDelete: "从工作区删除",
    applySentence: "采纳整句",
    dismiss: "关闭",
    insertHint: "采纳后：工作区会多出这段对照文字。可用顶栏「撤销」还原。",
    deleteHint: "采纳后：工作区会删掉这段。可用顶栏「撤销」还原。",
