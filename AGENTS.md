...
- **Word/phrase hover-accept (MVP: hover card on S-tier word units):** `docs/superpowers/plans/2026-07-15-word-hover-accept.md` · code: `features/diff/wordHover.ts`, `WordHoverCard.vue`, `MonacoDiff.vue`
